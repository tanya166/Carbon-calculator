...
const Offsetting = () => {
  ...
  if (loading) return <div style={{textAlign: 'center', padding: '100px', fontSize: '1.2rem'}}>Loading...</div>;
        ...
        <div className="sectionn1">
          ...
          <div className="faq">
            <button className="faq-title" onClick={toggleFaq1}>
              ...
              <span className="arrow">{showFaq1 ? '▲' : '▼'}</span>
            </button>
            {showFaq1 && (
          ...
          <div className="faq">
            <button className="faq-title" onClick={toggleFaq2}>
              ...
              <span className="arrow">{showFaq2 ? '▲' : '▼'}</span>
            </button>
            {showFaq2 && (
              <div className="faq-content">
                <p className="desc">
          ...
          <div className="faq">
            <button className="faq-title" onClick={toggleFaq3}>
              ...
              <span className="arrow">{showFaq3 ? '▲' : '▼'}</span>
            </button>
            {showFaq3 && (
              <div className="faq-content">
                <p className="desc">
